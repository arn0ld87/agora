"""Context-Window-Aufloesung (num_ctx) — aus ``llm_client.py`` extrahiert (#582).
...
# Gleicher Logger-Name wie app.llm.client — logging.getLogger liefert das
# Singleton, damit patch.object(llm_client.logger, ...) in Tests auch die
# Warnings aus diesem Modul sieht.
logger = get_logger("agora.llm_client")

# Tabelle SYNCED mit backend/scripts/agent_tools.py::_MODEL_CONTEXT_HEURISTICS
# (dort weiterhin eigene Kopie wegen Zirkular-Import-Sperre durch
