...
from .context import (  # noqa: F401 — Re-Exports fuer die Fassade app.utils.llm_client
    _MODEL_CONTEXT_HEURISTICS,
    _resolve_num_ctx,
    _warn_legacy_fallback_once,
    heuristic_num_ctx_for_model,
)
from .json_mode import (  # noqa: F401 — Re-Exports fuer die Fassade app.utils.llm_client
    JsonSchemaLike,
    _CODEFENCE_HEAD_RE,
    _CODEFENCE_TAIL_RE,
    _STRICT_DROP_KEYS,
    ...
    _is_unsupported_open_object,
    _read_active_config_safely,
    _strip_llm_json_envelope,
    _try_repair_truncated_json,
    should_disable_openai_json_mode,
)
from .providers.ollama import build_ollama_extra_body
from .providers.openai import uses_max_completion_tokens
