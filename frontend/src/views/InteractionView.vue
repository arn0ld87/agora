...
.step-name { font-family: var(--ff-serif); font-size: var(--fs-20); color: var(--ink-0); }
.status-tag { display: inline-flex; align-items: center; gap: var(--s-2); font-family: var(--ff-mono); font-size: 11px; letter-spacing: var(--ls-mono); text-transform: uppercase; color: var(--fg-muted); }
