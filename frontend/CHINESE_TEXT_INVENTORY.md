# Agora Frontend - Chinese Text Translation Inventory

## Overview
Complete inventory of Chinese text found in the Agora frontend application that requires translation to English.
...
- `<meta name="description" content="Agora - 社交媒体舆论模拟系统" />` (Agora - Social Media Opinion Simulation System)
- `<title>Agora - 预测万物</title>` (Agora - Predict Everything)
