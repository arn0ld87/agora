...
--   Agora-Artefakte); nur mirrored_at setzt der Server (default now()).
...
-- das Schema (schema `agora` ist zudem nicht in dbExposedSchemas, also
-- via Kong/PostgREST erst gar nicht adressierbar).
