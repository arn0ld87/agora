...
`0.9.6` liegt zwischen `0.9.5` (11.08.2026) und `0.10.0` und enthält 331 Commits sowie 181 Changelog-Fragmente seit `v0.9.5`. Es ist ausdrücklich **kein** `0.10.0` und erfüllt dessen Release-Gates (siehe unten) nicht — Feature-Freeze beginnt erst mit dem ersten `0.10.0`-RC.
