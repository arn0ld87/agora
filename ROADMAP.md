...
- [ ] **Budget vollständig über alle produktiven Pfade:** der separate `ParallelIPCHandler` des Default-Parallelrunners muss dieselbe Report-Budget-Attribution wie der normale IPC-Pfad erhalten (Follow-up zu #1478) — **ERLEDIGT (Slice 3.1)**.
