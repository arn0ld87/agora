...
**Files:**
- Modify: `docu/2026-05-04-task-46-report-agent-split-arbeitsprotokoll.md`
- Test: `backend/tests/contracts/`
- Test: `backend/tests/services/test_report_agent*.py`

**Step 1: Arbeitsprotokoll schreiben**

Create: `docu/2026-05-04-task-46-report-agent-split-arbeitsprotokoll.md`
...
```bash
git add backend/app/services/report_agent docu/2026-05-04-task-46-report-agent-split-arbeitsprotokoll.md
...
Plan complete and saved to `docu/plans/2026-05-04-issue-202-report-agent-split.md`. Two execution options:
