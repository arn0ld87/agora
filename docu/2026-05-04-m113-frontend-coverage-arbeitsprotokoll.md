...
| `docu/STATUS.md` | Neue Sektion `Frontend-Coverage (M11.3)` mit Messwerten, Schwellenbegründung und Roadmap-Tabelle; Aktualisierungsprotokoll-Eintrag |
| `CHANGELOG.md` | Eintrag unter `[Unreleased] ### Added` |
| `docu/2026-05-04-m113-frontend-coverage-arbeitsprotokoll.md` | dieses Dokument |
