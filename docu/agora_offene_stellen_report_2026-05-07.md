...
**Stand:** 2026-05-07  
**Repo:** `arn0ld87/agora`  
**Basis:** GitHub-Connector-Auswertung von Issues, PRs, Workflow-Runs, `docu/STATUS.md`, `docu/dependency-risk-register.md`, CI-Workflows, Dockerfile und Compose-Dateien.
...
`docu/STATUS.md` nennt als nächste offene Phase:
...
Aufgaben:
1. Lies AGENTS.md, docu/STATUS.md, docu/dependency-risk-register.md, .github/workflows/ci.yml, backend/pyproject.toml und backend/uv.lock.
...
7. Erstelle oder aktualisiere eine Markdown-Datei unter docu/ mit dem Namen docu/2026-05-07-dependency-triage-camel-oasis-camel-ai.md.
