...
**Datum:** 2026-04-29
**Slice/PR:** `refactor/code-quality-pass` (P2 aus `REFACTORING_PLAN.md`)
...
- `REFACTORING_PLAN.md` — P2 ist damit erledigt.
- `docu/2026-04-29-p0-2a-signed-tickets.md` / `…-p0-2c-frontend-tickets.md` — Kontext, warum URL-Tickets überhaupt vorkommen können.
