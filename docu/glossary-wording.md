...
**Geltungsbereich:** README, `docu/`, alle Backend-Strings, die im Report sichtbar werden, und alle LLM-Prompts in `backend/app/services/`.
...
2. **README, `docu/`, UI-Texte und Commit-Bodies** verwenden die DE-Spalte.
3. **Historische Logs** (`docu/logs/log_neu.md`, `docu/logs/log1_analyse.md`) werden **nicht** rückwirkend angepasst — sie sind Zeitdokumente.
