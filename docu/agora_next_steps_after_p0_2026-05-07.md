...
4. `docu/dependency-risk-register.md` aktualisieren:
...
Aufgaben:
1. Lies AGENTS.md, docu/STATUS.md, docu/dependency-risk-register.md und die P0-Triage-Doku.
...
4. Aktualisiere docu/dependency-risk-register.md nur, wenn sich durch P0 echte CVE-Auflösung oder neue Blocker ergeben haben.
...
- Ergebnis ist als kurze Markdown-Doku unter docu/ abgelegt.
...
- M11 nächste Ziele laut docu/STATUS.md:
...
Aufgaben:
1. Lies AGENTS.md, CLAUDE.md, docu/STATUS.md und PLAN.md.
...
7. Führe Checks aus:
   ...
   cd backend && uv run mypy app
   git diff --stat
8. Dokumentiere den Slice unter docu/<datum>-m11-phase5-hotspot-refactor.md.
