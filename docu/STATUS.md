...
1. M10.5 Rate-Limit-Konzept — `/api/auth/ticket`, Upload-Pfad `/api/graph/ontology/generate` und Simulation-LLM-Trigger `/api/simulation/generate-profiles` + `/api/simulation/prepare` rate-limited (#302); offen bleibt Report-Gen.
