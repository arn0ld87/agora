...
| 9 | Prod-Deployment | grün — Reverse-Proxy ✅, gevent ✅, Bundle-Token-Gate ✅, `?token=`-Block ✅, signed-tickets-Frontend ✅, Prod-Stack-Smoke in CI ✅ (`docker-image.yml::prod-proxy-smoke` als PR-Gate), Auth-ADR ✅ (M10.4 Single-User-only-v1 Accepted). |
