...
**Related:**
[`docu/deployment.md`](./deployment.md) · [`docu/deployment-prod-like.md`](./deployment-prod-like.md) ·
[`docu/backup-restore.md`](./backup-restore.md) ·
[`docu/secret-key-lifecycle.md`](./secret-key-lifecycle.md) ·
[`docu/security-hardening.md`](./security-hardening.md).
...
| `AGORA_SECRET_KEY` | ja (sobald Multi-Provider-Hub genutzt) | Fernet-Master-Key für `backend/data/llm_provider_secrets.json`. **Verlust = Datenverlust.** Siehe `docu/secret-key-lifecycle.md`. |
...
Vollständige Subcommand-Doku: [`docu/secret-key-lifecycle.md`](./secret-key-lifecycle.md).
...
Komplette Tabelle der Assets in [`docu/backup-restore.md`](./backup-restore.md).
Kurz-Routine:
...
# Neo4j-Dump (siehe docu/backup-restore.md)
...
- **`AGORA_SECRET_KEY` separat vom Repo sichern.** Das ist der
  ...
  [`docu/secret-key-lifecycle.md`](./secret-key-lifecycle.md#verlust-verhalten).
