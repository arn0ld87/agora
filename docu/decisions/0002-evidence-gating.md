...
| Slice | Inhalt | Status |
|---|---|---|
| **M11.7a** | Prompt-Block + Hedge-Snapshot-Test | Accepted (dieser Slice) |
| **M11.7b** | Schema + Validators + Drift-Guards | offen |
| **M11.7c** | `ReportSectionModel.hypotheses[]` + Frontend-Renderer | offen |
