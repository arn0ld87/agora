...
| **M10.4** | 🚧 | Auth-Zielbild-ADR | `agora-doc-worker` (+ Lead) | `/agora-next-task` | Haiku + Senior | `docu/decisions/0001-auth-model.md` als **Proposed** angelegt — Empfehlung Single-User-only-v1 (Option A). Wartet auf User-Sign-off. |
