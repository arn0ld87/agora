...
Guidance für Codex und andere Agent-Runtimes in diesem Repository. Die ausführlichen Workflows liegen unter [docs/runbooks/](docs/runbooks/).
...
- Keine US-Cloud-Lock-ins einführen; Ollama-/OpenAI-kompatible Fallbacks bleiben Pflicht.
...
3. LOW kann mit Begründung out of scope bleiben.
