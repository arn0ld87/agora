...
Verwandte Dokumente:
- [`deployment-prod.md`](deployment-prod.md) — Update- und
...
Datei: `docs/archive/history/<YYYY-MM-DD>-v<NEW>-release-notes.md`. Vorlage:
[`docs/archive/history/2026-05-01-v0.9.0-release-notes.md`](archive/history/2026-05-01-v0.9.0-release-notes.md).
...
git add CHANGELOG.md package.json frontend/package.json \
        ...
        frontend/src/i18n/locales/de.json frontend/src/i18n/locales/en.json \
        README.md docs/archive/history/<datum>-v<NEW>-release-notes.md
...
gh release create "v$NEW" \
  --title "Agora v$NEW" \
  --notes-file "docs/archive/history/<datum>-v<NEW>-release-notes.md"
```
...
- Migrations-Inhalt von Releases steht in den jeweiligen
  Release-Notes-Dateien unter `docs/archive/history/<datum>-v<X.Y.Z>-release-notes.md`.
