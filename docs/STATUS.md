...
|---|---|---|
| Backend Tests (collected) | 4118 | `cd backend && uv run pytest --collect-only -q` |
| Frontend Test-Files | 176 | `find frontend/src \( -name '*.spec.ts' -o -name '*.spec.js' -o -name '*.test.ts' -o -name '*.test.js' \)` |
<!-- END_AUTOGEN_TESTS -->
