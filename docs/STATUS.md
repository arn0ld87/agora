...
Offen bleiben Pronomenauflösung über Chunk-Kontext mit Abschnittstitel (#1292), die Ableitung der Persona-Art aus der semantischen Klasse und LLM-gestützte Koreferenz (#1470).
...
- Dokumente tragen eine Textsorte (`document_role`, beim Upload je Datei wählbar). Szenario-, Frage- und Erwartungstext stützt keinen Claim; ein Claim, der nur daran hängt, wird als Hypothese mit Hinweis auf den Testfall geführt ([#1240](https://github.com/arn0ld87/agora/issues/1240)). Offen: der bereinigte Gegenprobe-Lauf gegen ein Seed ohne Meta-Text, und Seeds, die Szenario und Erwartung in **einer** Datei mischen, bleiben ungetrennt — die Rolle gilt je Dokument.
...
3. #1470 — **Teil erledigt.** Deterministische Alias-Auflösung und semantische Entitätsklasse vor dem Cap; offen sind Pronomenauflösung über Chunk-Kontext (#1292) und LLM-Koreferenz. #1471 (Persona-Domänenkohärenz) ist abgeschlossen: Hauptdomänen-Vergleich statt Any-Overlap, Branchenquote nur für synthetische Vertreter, Drift-Korrektur der Biografie.
4. #1236/#1323 — Recommender- und Rollen-Konsistenz der Simulation. #1323: Messung steht (Slice 5.1), das Konsistenz-Gate (5.2) wartet auf das Review der Baseline.
5. #1345/#1240 — Quantoren/Evidence und Eval-Leakage. Beide Code-Slices stehen; für #1240 fehlt der bereinigte Gegenprobe-Lauf (Slice 6.4).
