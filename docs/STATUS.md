...
|---|---|---|
| Backend Tests (collected) | 4202 | `cd backend && uv run pytest --collect-only -q` |
| Frontend Test-Files | 182 | `find frontend/src \( -name '*.spec.ts' -o -name '*.spec.js' -o -name '*.test.ts' -o -name '*.test.js' \)` |
<!-- END_AUTOGEN_TESTS -->
