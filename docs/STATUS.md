...
- Statusmeldungen von Prepare, Report, Graph-Tasks und seit #1557 auch der Run-Lifecycle (`RunDetail`, Regal/Dossier) tragen einen stabilen `message_key`; das Frontend übersetzt ihn über `resolveStatusMessage`, der Klartext bleibt Fallback.
