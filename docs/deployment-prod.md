...
[`security.md`](security.md), Phase 1 / Slice 1.
...
Preflight-Verhalten siehe [`security.md`](security.md),
Phase 2.
...
[`docs/archive/worklogs/2026-05-04-n1-docker-publish-order-arbeitsprotokoll.md`](archive/worklogs/2026-05-04-n1-docker-publish-order-arbeitsprotokoll.md).
...
- [`security.md`](security.md) — Phase 1/2/3 + P1
