...
|---|---|---|---|
| **A** | Token-Port | **abgeschlossen** | `agora-v3.css` als Basis fuer `tokens-v3.css`; Compat-Layer dokumentiert; Worklog in `docs/design/2026-05-11-design-v4-slice-a-tokens.md` |
