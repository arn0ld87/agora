...
- ~~Langfristig: echte Session-/Login-Auth statt Static-Token.~~ Durch [ADR-0001](adr/0001-auth-model.md) (2026-05-04, Accepted) beantwortet: v1.0 bleibt **bewusst Single-User-only**, ein echtes Session-/Login-Modell ist v2-Material. Siehe Sektion „Auth-Modell v1.0" am Ende dieses Dokuments.
...
**Stand:** 2026-05-04. Siehe [`docs/adr/0001-auth-model.md`](adr/0001-auth-model.md) für die volle ADR mit Optionen-Vergleich und Begründung.
