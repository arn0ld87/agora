...
> Stand: 2026-05-04. Verbindliche Test-Counts und Layer-Status: [`docs/STATUS.md`](STATUS.md). Layer-Detailtabelle: [`CLAUDE.md`](../CLAUDE.md#architektur-layer-status). Operative Tasks: [`PLAN.md`](../PLAN.md). Subagent-Mapping pro Slice: [`docs/plan.heuristic.md`](plan.heuristic.md). Versions-Historie und Detail-Backlog: `docs/refactoring-backlog.md`, `docs/p0-arbeitsprotokoll.md`, `CHANGELOG.md`.
...
- **M9.7 Doku-Sync** — `AGENTS.md`/`CLAUDE.md`/`PLAN.md`/`STATUS.md`/`docs/plan.heuristic.md` auf realen Code-Stand 2026-05-04 ziehen (= dieser Slice).
