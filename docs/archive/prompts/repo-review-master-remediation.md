...
4. `docs/2026-05-01-v0.9.0-release-notes.md` — was v0.9.0 wirklich enthält.
...
6. `.env.example`, `Dockerfile`, `docker-compose.yml`,
   ...
   `backend/app/utils/signed_ticket.py`, `docs/security.md`.
...
- **Slice-Workflow:** Jeder PR aus dem Review wird in 1–N Sub-Slices à
  ...
  4. `docs/<YYYY-MM-DD>-<slice-id>-arbeitsprotokoll.md` mit Ziel,
...
- `README.md`:
  ...
  - Engineering-Stand (DE + EN) aus
    `docs/2026-05-01-v0.9.0-release-notes.md` ableiten.
  ...
  - Neo4j-Browser auf `http://localhost:7474` nur erwähnen, wenn Slice 0
    ...
    Loopback gehärtet."
- `docs/v1-development-log.md` (falls vorhanden): Eintrag „Doku-Sync
  v0.9.0 abgeschlossen".
- `docs/<YYYY-MM-DD>-slice-0-readme-v090-sync-arbeitsprotokoll.md`.
...
- `docs/security.md`: Abschnitt zu Tickets aktualisieren.
...
- `docs/dependency-risk-register.md` (neu):
...
- `gh issue list --label dependency-baseline` zeigt einen Eintrag pro
  ignorierter CVE.
- `docs/dependency-risk-register.md` existiert mit allen Einträgen.
...
- `docs/auth.md` (neu): Token-Header, Ticket-Flow,
...
- `docs/<datum>-slice-<n>-*-arbeitsprotokoll.md` existiert je Slice.
- README + `docs/security.md` + `docs/auth.md` +
  `docs/dependency-risk-register.md` reflektieren den neuen Stand.
