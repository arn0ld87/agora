...
**Bezug:** [`docs/2026-05-01-v0.9.0-review-folge-slices-plan.md`](2026-05-01-v0.9.0-review-folge-slices-plan.md), Sub-Slice F1.
...
- F1-Scope laut Plan:
  - `docs/deployment-dev.md`: Lokaler Dev-Betrieb (Vite + Flask, ohne
  ...
  - `docs/deployment-prod.md`: Gunicorn (`--workers 2`),
...
2. `docs/deployment-dev.md` geschrieben:
...
3. `docs/deployment-prod.md` geschrieben:
...
| Datei | Aktion | LOC ca. |
|---|---|---|
| `docs/deployment-dev.md` | neu | 180 |
| `docs/deployment-prod.md` | neu | 245 |
| `README.md` | edit (3 Stellen) | +20 / -5 |
| `CHANGELOG.md` | edit (`[Unreleased]` → neuer `### Docs`-Block) | +4 |
| `docs/2026-05-01-slice-7-deployment-doku-arbeitsprotokoll.md` | neu | dieses File |
...
- README-Verlinkungen sichtgepruefte Anchor (`./docs/deployment-dev.md` und
  `./docs/deployment-prod.md`) — Markdown-Render in GitHub funktioniert,
  Pfade relativ.
...
- [x] `docs/deployment-dev.md` existiert und deckt Bare-Metal + Compose-Dev
      ab; verweist auf `auth.md`.
- [x] `docs/deployment-prod.md` existiert und deckt Gunicorn,
