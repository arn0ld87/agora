...
Den im PR #334 verankerten Output-Vertrag (`docs/2026-05-09-output-vertrag-bewertung-evidence-quality.md`) maschinenprüfbar machen, ohne den vollen Eval-Korpus (seed.md / prompt.md / pdf / evidence.json) zu benötigen — die liegen aktuell nicht im Repo.
...
| `docs/status.md` | zu syncen | `sync-status.sh` läuft nach Commit |
