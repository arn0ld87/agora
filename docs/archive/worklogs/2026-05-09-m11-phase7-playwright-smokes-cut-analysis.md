...
**Quelle:** [`docu/agora_next_steps_after_p0_2026-05-07.md`](agora_next_steps_after_p0_2026-05-07.md) § P1-D · [`PLAN.md`](../PLAN.md) `Aktiv offen` M11.4
...
- `docu/2026-05-09-m11-4a-playwright-setup-arbeitsprotokoll.md`
- `CHANGELOG.md` `[Unreleased]`
- `docu/STATUS.md` (sync-status.sh-Pflicht)
