...
**Start:** 2026-04-22  
**Ziel:** P0 aus `docs/refactoring-backlog-priorisiert.md` kleinteilig umsetzen und jeden Schritt nachvollziehbar dokumentieren.
...
- zusätzliches Detailprotokoll: `docs/p0-graph-panel-modularisierung-protokoll.md`
...
- Refactoring-Dokumentation unter `docs/` im README verlinkt
...
- zusätzliches Detailprotokoll: `docs/p0-embedding-config-hardening-protokoll.md`
...
- zusätzliches Detailprotokoll: `docs/p0-polling-composable-protokoll.md`
...
**Neue Datei**
- `docs/p0-root-cleanup-protokoll.md`
...
- Log-Skripte wurden von `docs/logs/...` auf `docs/logs/...` umgestellt
...
- zusätzliches Detailprotokoll: `docs/p0-simulation-json-hardening-protokoll.md`
...
- zusätzliches Detailprotokoll: `docs/p0-workspace-layout-protokoll.md`
...
**Geänderte Datei**
- `frontend/src/views/SimulationRunView.vue`
- Detailprotokoll aktualisiert: `docs/p0-workspace-layout-protokoll.md`
...
**Neue Datei**
- `docs/p0-backend-ruff-rollout-protokoll.md`
...
**Neue Datei**
- `docs/p0-frontend-build-hygiene-protokoll.md`
...
**Neue Datei**
- `docs/p0-legacy-process-view-cleanup-protokoll.md`
