...
**Scope:** `.github/workflows/docker-image.yml`, `docs/deployment-prod.md`, `CHANGELOG.md`
...
| `docs/deployment-prod.md` | geändert | Neuer Abschnitt "Release-Pipeline (CI/CD)" |
| `CHANGELOG.md` | geändert | `[Unreleased] ### Fixed` Eintrag |
| `docs/2026-05-04-n1-docker-publish-order-arbeitsprotokoll.md` | neu | dieses Protokoll |
