...
Slice 1 aus `docs/2026-04-29-v07-umsetzungsplan.md` weiterführen: vorhandene Agora-Design-Tokens produktiv nutzen und harte Hauptfarben im Frontend weiter reduzieren, ohne eine visuelle Neugestaltung vorzunehmen.
...
4. `docs/2026-04-29-v07-umsetzungsplan.md` gelesen und Slice 1 als aktuellen Scope bestätigt.
5. `docs/agora_weiterentwicklung.md` gelesen und das Zielbild Design-System aus Design-Quellen in Vue-Frontend übernommen.
