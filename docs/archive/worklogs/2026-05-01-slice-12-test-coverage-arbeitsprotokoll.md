...
**Bezug:** [`docs/2026-05-01-v0.9.0-review-folge-slices-plan.md`](2026-05-01-v0.9.0-review-folge-slices-plan.md), Sub-Slice F5.
...
| `docs/2026-05-01-slice-12-test-coverage-arbeitsprotokoll.md` | neu | dieses File |
...
- F6 — Branch-Cleanup + README-Update (letzter Sub-Slice des
  Folge-Plans).
- Optional: docs/operations.md erwaehnt `/api/health/auth` — der neue
