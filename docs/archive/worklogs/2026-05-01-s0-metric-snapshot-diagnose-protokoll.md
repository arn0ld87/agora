...
**Plan:** [docs/2026-05-01-evidence-pipeline-plan.md](2026-05-01-evidence-pipeline-plan.md)
...
Vollständiger Bericht: [docs/2026-05-01-metric-snapshot-diagnose.md](2026-05-01-metric-snapshot-diagnose.md).
...
Der Plan wurde um **S2-pre** ergänzt: Schema-Fix vor Status-Flag-Hardening. Reihenfolge-Update in [docs/2026-05-01-evidence-pipeline-plan.md](2026-05-01-evidence-pipeline-plan.md) gepflegt.
...
- `docs/2026-05-01-evidence-pipeline-plan.md` (neu) — Master-Plan, mit S2-pre nachgezogen
- `docs/2026-05-01-metric-snapshot-diagnose.md` (neu) — Diagnose-Bericht
- `docs/2026-05-01-s0-metric-snapshot-diagnose-protokoll.md` (neu) — dieses Protokoll
