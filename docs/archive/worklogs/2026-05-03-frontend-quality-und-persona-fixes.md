...
5. Ergebnis als `docu/2026-05-03-request-rate-audit.md` ablegen mit Tabelle: Component → Endpoint → Frequenz → Trigger → Bewertung → Empfehlung.
...
4. Wording-Glossar v1 (`docu/glossary-wording.md`) prüfen — keine `prediction`-Phrasen, keine US-Marketing-Buzzwords im neuen Prompt.
...
- **Wording-Glossar** — `docu/glossary-wording.md` nicht verletzen.
