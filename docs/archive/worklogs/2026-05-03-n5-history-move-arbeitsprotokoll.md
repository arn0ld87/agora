# Arbeitsprotokoll N5 — Veraltete Repo-Root-Audits nach `docs/archive/history/`
...
| Alt (Repo-Root) | Neu (`docs/archive/history/`) |
|---|---|
| `agora_evidence_pipeline_testfall.md` | `docs/archive/history/2026-04-2x-evidence-pipeline-testfall.md` |
| `agora_json_evdence_review.md` | `docs/archive/history/2026-04-2x-json-evidence-review.md` |
| `agora_repo_review_neuer_stand.md` | `docs/archive/history/2026-04-2x-repo-review-neuer-stand.md` |
| `agora_repository_review.md` | `docs/archive/history/2026-04-2x-repository-review.md` |
...
> Aktueller Stand siehe: `CLAUDE.md` / `PLAN.md` / `docs/status.md`
...
ls docs/archive/history/ | wc -l                # → ≥ 4
```
