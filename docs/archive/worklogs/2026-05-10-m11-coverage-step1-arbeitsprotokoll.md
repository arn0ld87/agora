...
```
bash scripts/sync-status.sh --check -> OK: docu/STATUS.md in sync
```
...
| `docu/STATUS.md` | Backend-Schwelle, Backend-Roadmap-Tabelle, Frontend-Schwelle, Frontend-Roadmap-Tabelle, Milestone-Erledigt-Zeilen, Mittelfristig-Zeile |
| `CHANGELOG.md` | Bullet unter `[Unreleased] ### Changed` |
| `docu/2026-05-10-m11-coverage-step1-arbeitsprotokoll.md` | dieses Protokoll |
