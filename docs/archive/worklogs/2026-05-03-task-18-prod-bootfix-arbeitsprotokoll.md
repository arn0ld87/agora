...
| [docu/deployment-prod-like.md:289–296](docu/deployment-prod-like.md:289) | „Ollama läuft auf dem Host… Container nutzt `host.docker.internal` per `extra_hosts: host-gateway`" |
...
- `docu/2026-05-03-task-18-prod-bootfix-arbeitsprotokoll.md` (neu)
...
dem ursprünglichen Prod-Slice (siehe [docu/2026-04-29-prod-slice2-gunicorn.md](docu/2026-04-29-prod-slice2-gunicorn.md))
