...
Slice 2 aus `docs/2026-04-29-v07-umsetzungsplan.md` startet die Persona Review Foundation: generierte und manuell hinzugefuegte Personas bekommen einen pruefbaren Lifecycle, koennen editiert und freigegeben werden, ohne den OASIS-Subprozess oder die `simulation_config.json`-Generierung anzufassen.
...
Naechster sinnvoller Schritt aus `docs/2026-04-29-v07-umsetzungsplan.md`: **Slice 3 Run Dashboard** oder **Slice 4 Evidence & Confidence MVP**.
