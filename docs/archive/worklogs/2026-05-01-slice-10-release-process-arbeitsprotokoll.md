...
**Bezug:** [`docs/2026-05-01-v0.9.0-review-folge-slices-plan.md`](2026-05-01-v0.9.0-review-folge-slices-plan.md), Sub-Slice F4.
...
- F4-Scope laut Plan:
  - `docs/release-process.md` mit allen Versionsquellen, der Reihenfolge
...
2. `docs/release-process.md` strukturiert:
...
3. README-Doku-Index (DE + EN) um Zeile `Release-Process: docs/release-process.md` ergaenzt.
...
| Datei | Aktion | LOC ca. |
|---|---|---|
| `docs/release-process.md` | neu | 200 |
| `README.md` | edit (DE + EN Doku-Index) | +2 |
| `CHANGELOG.md` | edit (`[Unreleased] › Docs` neuer Slice-10-Block) | +2 |
| `docs/2026-05-01-slice-10-release-process-arbeitsprotokoll.md` | neu | dieses File |
...
- [x] `docs/release-process.md` existiert.
- [x] Reproduzierbares Rezept (Schritte 1-6 mit konkreten Commands).
- [x] Verweis auf existierende Release-Notes (`docs/2026-05-01-v0.9.0-release-notes.md`).
