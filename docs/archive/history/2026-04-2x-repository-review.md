...
> - Test-Status: `docs/status.md`
> - Diese Datei wurde aus dem Repo-Root nach `docs/archive/history/` verschoben.
>
---
...
- Doku in `security.md` aktualisieren.
...
- `docs/deployment-dev.md`: lokaler Dev-Betrieb mit Vite + Flask.
- `docs/deployment-prod.md`: Gunicorn, Reverse Proxy, Auth, CORS, Tailscale/WireGuard.
- `docs/security-threat-model.md`: Assets, Trust Boundaries, Angreifer, bekannte Restrisiken.
- `docs/dependency-risk-register.md`: ignorierte CVEs, Owner, Zielversion, Frist.
- `docs/auth.md`: Token-Header, Ticket-Flow, Query-Token-Deprecation, localStorage-Risiko.
- `docs/backup-restore.md`: Neo4j-Daten, Upload-Artefakte, Reports, Simulationen.
- `docs/operations.md`: Logs, Healthchecks, Ressourcenbedarf, Redis/Neo4j/Ollama-Ausfall.
- `docs/release-process.md`: Versionsquellen synchronisieren, Changelog, Tags, Container-Images.
