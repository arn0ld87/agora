...
> - **Test-Counts und Versionen:** [`docs/status.md`](../status.md)
> - **Subagent-Routing pro Slice:** [`docs/runbooks/plan.heuristic.md`](../plan.heuristic.md)
...
- `CONTRIBUTING.md`
- `SECURITY.md`
- `docs/archive/reviews/SECURITY_REVIEW.md`
- `.env.example`
- `Dockerfile`
- `docker-compose.yml`
...
| F5a | ✅ | Status-Doku | `docs/status.md` existiert als zentrale Status-/Testcount-Datei. |
...
| M9.7 Doku-Sync M9 | ⬜ | 🟡 | `README.md`, `CLAUDE.md`, `AGENTS.md`, `status.md`, `docs/archive/reviews/SECURITY_REVIEW.md` widersprechen sich nicht mehr. |
...
| M10.3 Dependency Risk Register aktualisieren | ⬜ | 🟡 | `docs/dependency-risk-register.md` enthält Owner, Upstream-Link, Deadline, Eskalationspfad. |
...
| M13.5 Doku-Archivierung | ⬜ | 🟢 | Alte Pläne nach `docs/archive/history/`, aktive Quellen klar: `PLAN.md`, `docs/status.md`, `docs/ROADMAP.md`, ADRs. |
...
3. **Auth-Zielbild entscheiden**
   - Datei: `docs/adr/0001-auth-model.md`
...
4. **Doku-Drift bereinigen**
   - Dateien: `AGENTS.md`, `CLAUDE.md`, `status.md`, `docs/archive/reviews/SECURITY_REVIEW.md`
...
1. **PR 1:** Doku-Sync für `AGENTS.md`, `CLAUDE.md`, `status.md`, `docs/archive/reviews/SECURITY_REVIEW.md`.
