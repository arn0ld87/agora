...
> **HISTORISCHER SNAPSHOT.** Dies ist der ADR-Drop vom 2026-05-04, der zusammen mit dem Backup-Master-Mapping aus `.git/agora-cleanup-backup-2026-05-04/plan.heuristic.md` in die offizielle [`docs/runbooks/plan.heuristic.md`](../plan.heuristic.md) konsolidiert wurde. Aktueller verbindlicher Stand:
>
> - **Subagent-Routing pro Slice + ADR-Live-Register:** [`docs/runbooks/plan.heuristic.md`](../plan.heuristic.md)
...
**Stand:** 2026-05-04  
**Repo:** `arn0ld87/agora`  
**Status:** Audit-Snapshot. Konsolidiert in [`docs/runbooks/plan.heuristic.md`](../plan.heuristic.md).
