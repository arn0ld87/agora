...
| P1 | `docs/status.md` + Sync-Skript | SSoT-Drift bei Versionen/Gate-Beschreibung | Sync-Skript auf Manifest-Versionen und CI-Quellen härten | XS |
...
- Code-Hotspots und Projektdoku: `backend/app/services/oasis_profile_generator.py`, `backend/app/services/graph_tools.py`, `backend/app/api/status.py`, `frontend/src/components/Step2EnvSetup.vue`, `frontend/src/components/Step4Report.vue`, `frontend/src/composables/usePolling.ts`, `docs/status.md`, `docs/dependency-risk-register.md`, `docs/adr/0001-auth-model.md`, `docs/security.md`, `CHANGELOG.md`, `docs/refactoring-backlog-priorisiert.md`.
