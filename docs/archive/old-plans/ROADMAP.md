...
> Stand: 2026-05-04. Verbindliche Test-Counts und Layer-Status: [`docs/status.md`](status.md). Layer-Detailtabelle: [`CLAUDE.md`](../CLAUDE.md#architektur-layer-status). Operative Tasks: [`PLAN.md`](../PLAN.md). Subagent-Mapping pro Slice: [`docs/runbooks/plan.heuristic.md`](plan.heuristic.md). Versions-Historie und Detail-Backlog: `docs/refactoring-backlog-priorisiert.md`, `docs/p0-arbeitsprotokoll.md`, `CHANGELOG.md`.
...
- **M9.7 Doku-Sync** — `AGENTS.md`/`CLAUDE.md`/`PLAN.md`/`status.md`/`docs/runbooks/plan.heuristic.md` auf realen Code-Stand 2026-05-04 ziehen (= dieser Slice).
- **M10.1/M10.2 CVE-Monitor + Hardstop** — wöchentlicher `pip-audit` ohne `--ignore-vuln`, Hardstop am 2026-07-30 (Issues #121–#126).
- **M10.4 Auth-Zielbild-ADR** — `docs/adr/0001-auth-model.md` entscheidet zwischen Single-User-only-v1, HttpOnly-Session und Bearer+Refresh.
