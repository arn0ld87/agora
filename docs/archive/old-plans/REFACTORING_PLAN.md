...
- **Dokumentation**: Security-Baseline als lebende Checkliste (`docs/archive/reviews/SECURITY_REVIEW.md` + issue-getriebene Umsetzung).
...
- Dokumentation: Details und Rollback in `docs/p1-security-ci-error-envelope-protokoll.md`.
