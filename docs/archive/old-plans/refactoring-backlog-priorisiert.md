...
**Stand:** 2026-04-22
**Basisdokument:** `docs/2026-04-22-refactoring-produkt-audit.md`
...
## Story EPIC-09-ST-01 — Einheitliches Fehlerformat definieren — **abgeschlossen**
**Typ:** Story
**Priorität:** P1
**Aufwand:** S
**Status:** ✅ done (ApiErrorCode-Katalog mit 23 Codes + DEFAULT_MESSAGES, `json_error()` auf ApiErrorCode umgestellt, Backwards-Compat gewährleistet, 9 foundation-Tests).
...
## Story EPIC-09-ST-02 — Response-Schemas für Kern-Endpoints definieren — **abgeschlossen**
**Typ:** Story
**Priorität:** P1
**Aufwand:** M
**Status:** ✅ done (31 Schema-Tests über 7 Domänen, jsonschema>=4.0.0 als Dev-Dep, `docs/api-contracts.md` mit Feldtabellen).
...
## Story EPIC-09-ST-03 — Frontend-Mapper für Backend-Responses einführen — **abgeschlossen**
**Typ:** Task
**Priorität:** P1
**Aufwand:** M
**Status:** ✅ done (`ApiError`-Klasse, `envelope.ts` + `errorMessages.ts`, Interceptor-Migration, HistoryDatabase.vue als Smoke-Test, +0.71 KB gzip Budget).
