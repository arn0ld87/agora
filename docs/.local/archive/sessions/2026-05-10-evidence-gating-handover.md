...
ADR-0002 (`docu/decisions/0002-evidence-gating.md`) ist die **verbindliche Spec**. Slice A hat die Anker 1 (Prompt) + 2 (Hedge-Snapshot) gesetzt, Slice B muss Anker 3 (Enum) + 4 (`cross_stakeholder_for_high`) + 5 (`reject_inferred_in_high_confidence`) setzen.
...
- `docu/2026-05-10-m11-7b-evidence-source-kind-arbeitsprotokoll.md` (NEU).
