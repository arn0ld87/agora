...
**Bezug:** [`docu/2026-05-01-v0.9.0-review-folge-slices-plan.md`](2026-05-01-v0.9.0-review-folge-slices-plan.md), Sub-Slice F6.
...
- F6-Scope laut Plan:
  - Lokal + Remote loeschen: `claude/v0.9.0-frontend-version` (Branch
    ...
    `rolle-du-bist-temporal-otter.md` gehoert nicht ins Repo).
  - Optional: weitere abgeschlossene Slice-Branches via `git branch -d`.
  - README: `docu/`-Index oder Doku-Sektion auf neue Dateien (F1–F4)
    verweisen.
...
1. [`docu/2026-05-01-v0.9.0-review-folge-slices-plan.md`](2026-05-01-v0.9.0-review-folge-slices-plan.md):
...
2. [`docu/2026-05-01-v0.9.0-repository-review.md`](2026-05-01-v0.9.0-repository-review.md)
   Statusblock:
...
3. README-Doku-Index final audiert (Stichprobe `grep -n docu/ README.md`):
...
| Datei | Aktion |
|---|---|
| `docu/2026-05-01-v0.9.0-review-folge-slices-plan.md` | Statusblock + F6-Marker |
| `docu/2026-05-01-v0.9.0-repository-review.md` | Action-Plan + Test-Cross-Check + Doku-Cross-Check |
| `CHANGELOG.md` | `[Unreleased] › Docs` Slice-13-Block |
| `docu/2026-05-01-slice-13-cleanup-arbeitsprotokoll.md` | dieses File |
