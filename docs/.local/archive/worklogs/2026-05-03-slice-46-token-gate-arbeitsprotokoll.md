...
| `docu/security-hardening.md` | Erweitert | Neue Section „F2.1 — VITE_AGORA_TOKEN per Build-Arg-Gate (Sub-Slice 46)" |
| `CHANGELOG.md` | Erweitert | `### Build`-Block um Sub-Slice-46-Eintrag ergänzt |
| `docu/2026-05-03-slice-46-token-gate-arbeitsprotokoll.md` | Neu | Dieses Dokument |
