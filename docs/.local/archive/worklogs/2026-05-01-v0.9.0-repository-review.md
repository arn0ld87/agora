...
| F1 / Slice 7: Deployment-Doku Dev + Prod-Like | ✅ erledigt | [`e472301`](../../../commit/e472301) — `docs(deployment): add deployment-dev.md + deployment-prod-like.md` |
...
| `docu/security-threat-model.md` — Assets, Trust Boundaries, Restrisiken | ✅ (Slice 8 / F2) |
| `docu/deployment-dev.md` — lokaler Dev-Betrieb Vite + Flask | ✅ (Slice 7 / F1) |
| `docu/deployment-prod-like.md` — Gunicorn, Reverse Proxy, Tailscale | ✅ (Slice 7 / F1) |
| `docu/backup-restore.md` — Neo4j, Uploads, Reports, Simulationen | ✅ (Slice 9 / F3) |
| `docu/operations.md` — Logs, Healthchecks, Ausfälle | ✅ (Slice 9 / F3) |
| `docu/release-process.md` — Versionsquellen, Changelog, Tags | ✅ (Slice 10 / F4) |
