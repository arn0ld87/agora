...
**Plan:** [`docu/2026-04-29-prod-setup-plan.md`](./2026-04-29-prod-setup-plan.md)
...
Aus dem Plan uebernommen (`docu/2026-04-29-prod-setup-plan.md`, Sektion
...
- `backend/uv.lock` — Lockfile-Update (gunicorn, gevent, greenlet, zope-event,
  zope-interface).
- `docu/2026-04-29-prod-slice2-gunicorn.md` — dieses Protokoll (lokal,
  `docu/` ist `.gitignore`d und wird nicht committed).
