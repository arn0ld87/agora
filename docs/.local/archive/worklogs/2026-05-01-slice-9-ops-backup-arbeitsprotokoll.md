...
**Bezug:** [`docu/2026-05-01-v0.9.0-review-folge-slices-plan.md`](2026-05-01-v0.9.0-review-folge-slices-plan.md), Sub-Slice F3.
...
- F3-Scope laut Plan:
  - `docu/operations.md`: Logs, Healthchecks, Ressourcenbedarf, Ausfaelle.
  - `docu/backup-restore.md`: Neo4j-Dump, Uploads, Reports, Cron,
    Restore-Drill.
...
2. `docu/operations.md` strukturiert:
...
3. `docu/backup-restore.md` strukturiert:
...
4. README-Doku-Index (DE + EN) um neue Zeile `Operations:
   docu/operations.md · docu/backup-restore.md` ergaenzt; gleichzeitig
...
| Datei | Aktion | LOC ca. |
|---|---|---|
| `docu/operations.md` | neu | 220 |
| `docu/backup-restore.md` | neu | 200 |
| `README.md` | edit (DE + EN Doku-Index) | +4 / -2 |
| `CHANGELOG.md` | edit (`[Unreleased] › Docs` neuer Slice-9-Block) | +2 |
| `docu/2026-05-01-slice-9-ops-backup-arbeitsprotokoll.md` | neu | dieses File |
...
- [x] `docu/operations.md` existiert mit Logs / Healthcheck / Ressourcen
      / Ausfaellen.
- [x] `docu/backup-restore.md` existiert mit Neo4j-Dump / Uploads /
      Reports / Cron / Drill.
