...
| [docu/2026-05-01-v0.9.0-release-notes.md](docu/2026-05-01-v0.9.0-release-notes.md) | 12/12 Issues, 671+40 = 711 Tests, Backend-`pyproject.toml` driftet noch auf 0.6.1. |
...
| [docu/security-hardening.md](docu/security-hardening.md) | Existiert; Tickets-Abschnitt muss in Slice 3 nachgezogen werden. |
| `docu/auth.md` | Existiert **nicht** — Slice 5 erstellt. |
| `docu/dependency-risk-register.md` | Existiert **nicht** — Slice 4 erstellt. |
...
- **Edits:** [README.md](README.md) (Status-Block, Engineering-Stand, Testzahlen, Schnellstart-Hinweis „Default-Compose baut aktuell `prod`-Stage; Neo4j auf 0.0.0.0 — wird in Slice 2/Slice 5 entschärft"), [docu/v1-development-log.md](docu/v1-development-log.md) (neuer Eintrag), neuer `docu/2026-05-01-slice-0-readme-v090-sync-arbeitsprotokoll.md`, [CHANGELOG.md](CHANGELOG.md) `[Unreleased] → Docs`.
...
- **Doku:** [docu/security-hardening.md](docu/security-hardening.md) Tickets-Sektion aktualisieren.
...
- **Neu:** [docu/dependency-risk-register.md](docu/dependency-risk-register.md) mit Tabelle (CVE | Paket | Owner | Frist | Status | Issue-Link).
...
- **Neu:** [docu/auth.md](docu/auth.md) mit Token-Header-Vertrag, Ticket-Flow, Query-Token-Deprecation, `localStorage`-Risiko, Empfehlung `HttpOnly`-Cookie/Session-Backend für Prod.
