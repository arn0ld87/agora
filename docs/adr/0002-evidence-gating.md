...
Der Prompt-Block hält Glossar v1 (siehe `docs/glossary-wording.md`) ein — keine Forecast-/Prediction-/Rehearsal-Vokabeln. Hedge-Wörter sind alle DACH-Voice-konform.
...
- [`docs/glossary-wording.md`](../glossary-wording.md) (Wording-Glossar v1)
