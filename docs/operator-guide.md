...
Prompt-Injection-Härtung der Simulations-`observation` ist seit #1224 für den Single-Platform-Tool-Loop umgesetzt (Kapselung + Tag-Neutralisierung); der parallele Simulationspfad und Fallback-Runden mit nativem CAMEL-`LLMAction()` bleiben offen.
