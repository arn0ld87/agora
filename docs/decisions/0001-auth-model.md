...
**Status:** Superseded by [ADR-0018](0018-multi-user-before-1-0.md) (2026-09-25); zuvor Accepted (User-Sign-off via Merge PR #277, 2026-05-04)
**Datum:** 2026-05-04
**Accepted:** 2026-05-04
**Slice:** M10.4
...
1. **Doku-Slice** (Haiku, ~1 Tag):
   - README + `docs/security-hardening.md` Single-User-Block ergänzen.
