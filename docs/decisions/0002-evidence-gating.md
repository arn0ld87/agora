...
Der Prompt-Block hält Glossar v1 (siehe `docs/glossary.md`) ein — keine Forecast-/Prediction-/Rehearsal-Vokabeln. Hedge-Wörter sind alle DACH-Voice-konform.
...
- [`docs/glossary.md`](../glossary.md) (Wording-Glossar v1)
